...
const Phases = () => (
  <section className="grav-u-pt-xxl grav-u-pb-xxl">
    <div>
      ...
      <div className="grav-u-pb-large"></div>
      <div className="section-heading">
        <h3 className="categoryText grav-o-full-bleed__content">
      ...
      <div className="grav-o-full-bleed__content c7-phase-2">
        <div className="grav-o-two-column">
          <ContentCard>
            ...
            <p className="cardText">
              Experiments consist of a meaningful experience for users in order
              to test and learn. This is a prototype containing a narrow slice
              of the overall proposition. Feedback between sprints leads to
              refinement of the experiments or pivoting. Hypotheses are

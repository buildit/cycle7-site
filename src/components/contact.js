...
const Contact = () => {
    ...
    const onFormSubmit = event => {
        ...
        xhr.open('POST', 'https://e67hj58402.execute-api.us-east-1.amazonaws.com/default/cycle-7-site-contact-form-to-slack', true);
            ...
            <section className="grav-o-full-bleed__content grav-u-pt-xxl grav-u-pb-xxl">
                ...
                <form ref={formRef} action="#" onSubmit={onFormSubmit}>
                    <fieldset ref={fieldSetRef}>
                        <input ref={nameRef} type="text" id="name" required="true" placeholder="Your Name"/><br/>
                        <input ref={emailRef} type="email" id="email" required="true" placeholder="Contact Email"/><br/>
                        <textarea ref={commentsRef} id="comments" placeholder="Any additional information?"/><br/>
                        <button ref={submitRef} type="submit" className="grav-u-font-size-plus-3">Contact us</button>
                        <div hidden="hidden" ref={loaderRef} className="sk-three-bounce grav-u-font-size-plus-3">
                            <div className="sk-child sk-bounce1"/>
                            <div className="sk-child sk-bounce2"/>
                            <div className="sk-child sk-bounce3"/>
                        </div>
                        <div hidden="hidden" ref={errorRef} className="form-error">
                            <p>There was a problem sending your contact details. Try again later?</p>
                        </div>
                    </fieldset>
                </form>
                <div hidden="hidden" ref={successRef} className="form-success">
